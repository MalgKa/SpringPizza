            ...
            <form action="/cart/agreed" method="post">
                ...
                <c:choose>
                    <c:when test="${!isCartEmpty}">
                        <button type="submit" class="btn btn-info cart-link confirm"
                                <c:if test="${isCartEmpty}">disabled</c:if>>confirm<i class="fa-solid fa-check"></i>
                        </button>
                    </c:when>
                    <c:otherwise>
                        <div class="alert alert-danger" role="alert">
                            Don't leave your cart hungry. Please <a href="/home" class="alert-link">add some goodies</a>
